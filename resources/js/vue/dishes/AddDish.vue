    ...
    <form @submit.prevent="saveDish()">
        <div class="blocks mt-3">
            <div class="block col-5">
                <label for="name"><b>نام ظرف</b></label>
            ...
            <div class="block col-5">
                <label for="dishes_categories_id"><b>دسته‌بندی ظرف‌ها</b></label>
        ...
        <div class="blocks mt-3">
            <div class="block col-5">
                <label for="recipes_collection_id"><b>دستورهای پخت</b></label>
            ...
            <div class="block col-5">
                <label for="description"><b>تکنولوژی پخت و پز</b></label>
        ...
        <div class="blocks mt-3">
            <div class="block col-5">
                <label for="culinary_processings_id"><b>فرآیند پخت و پز</b></label>
        ...
        <div class="blocks mt-3">
            <div class="block col-5">
                <label for="dishes_characters"><b>ویژگی‌های غذا</b></label>
            ...
            <div class="block col-5">
                <label for="techmap_number"><b>شماره</b></label>
        ...
        <div class="blocks mt-3 text-center">
            <button class="btn main-button-green" style="width: 100%">دخیره غذا</button>
        </div>
    </form>
