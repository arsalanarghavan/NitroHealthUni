<template>
    <div style="width:90%; margin: 0 auto;">
        ...
        <h1 class="text-center">لیست ظرف‌ها</h1>
        <b-button v-b-modal.modal-1 class="main-button-green mb-4">ایجاد ظرف جدید</b-button>
        <!--Modal window for create new Dish-->
        <b-modal id="modal-1" class="mb-4" size="lg" title="اضافه کردن یک ظرف جدید" hide-footer="true">
            <addDish @close-modal="closeModal('dishCreate')"></addDish>
        </b-modal>
        <!--Modal window for adding products to dish-->
        <b-modal id="modal-2" size="lg" hide-footer="true" title="اضافه کردن غذا به ظرف">
        ...
        <table v-else class="fl-table">
            <thead>
                <tr>
                    ...
                    <th scope="col" colspan="4">کنترل</th>
                </tr>
            </thead>
            <tbody>
