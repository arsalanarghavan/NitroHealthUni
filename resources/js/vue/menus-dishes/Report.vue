<template>
    <div style="width:80%; margin: 0 auto;">
        <h1 class="text-center">گزارش منو</h1>
        <form @submit.prevent="getReport()">
            ...
            <div style="width:50%; margin: 0 auto;">
                <button style="width:100%" class="btn main-button-green mt-4">نمایش</button>
            </div>
        </form>
            ...
            <div class="container days" v-for="(day, index) in post" :key="index">
                ...
                <div class="nutritions" v-for="(nutrition, index) in day.nutrition" :key="index">
                    ...
                    <table class="fl-table">
                        ...
                        <tr>
                            <th rowspan="2">شماره دستور غذایی</th>
                            <th rowspan="2">نام ظرف</th>
                            <th rowspan="2">Выход</th>
                            <th rowspan="2">پروتئین</th>
                            <th rowspan="2">چربی</th>
                            <th rowspan="2">کربوهیدرات</th>
                            <th rowspan="2">ارزش غذایی</th>
                            <th colspan="5">ویتامین</th>
                            <th colspan="6">مواد معدنی</th>
                        </tr>
                        <tr>
