<template>
    <div style="width:80%; margin: 0 auto;">
        ...
        <h1 class="text-center">عملکرد منو</h1>
        <form @submit.prevent="menusDishesIndex()">
            <div class="row">
                <div class="col-4">
                    <label for="menu_id"><b>منو</b></label>
                    <select id="menu_id" class="form-control" @change="setFirstMenu" v-model="form.menu_id">
                        <option value="null" disabled selected hidden>انتخاب منو...</option>
                ...
                <div class="col-4">
                    <label for="days_id"><b>روزها</b></label>
                ...
                <div class="col-4">
                    <label for="nutrition_id"><b>وعده‌های غذایی</b></label>
            ...
            <div class="blocks mt-3 text-center">
                <button class="btn main-button-green" style="width:100%">نمایش</button>
            </div>
        </form>
        ...
        <div class="container mt-5 mb-2" v-if="post">
            <div class="container">
                <p class="text-center" style="font-size: 20px;">غذاهای موجود در منو</p>
                <table class="fl-table">
                    <thead>
                    <tr>
                        <th scope="col">ترتیب</th>
                        <th scope="col">نام ظرف</th>
                        <th scope="col" class="text-center">وزن ظرف</th>
                        <th scope="col" class="text-center">کنترل</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr v-if="menusDishes.length === 0">
                        <td class="text-center text-danger" colspan="3"><b>مواردی که به منو اضافه نشده‌اند</b></td>
                    </tr>
            ...
            <form @submit.prevent="menusDishesStore()">
                <div class="row">
                    <div class="col-4">
                        <label for="dishes_id"><b>ظرف</b></label>
                    ...
                    <div class="col-4">
                        <label for="yield"><b>عملکرد بر حسب گرم</b></label>
                        <input id="yield" class="form-control" type="text" v-model="form.yield" autocomplete="off">
                    </div>
                    <div class="col-4">
                        <button class="btn main-button-green mt-4 justify-content-center">افزودن به منو</button>
                    </div>
                </div>
            </form>
        </div>
